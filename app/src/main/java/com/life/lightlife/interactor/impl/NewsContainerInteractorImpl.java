...
import com.life.lightlife.interactor.CommonContainerInteractor;
...
public class NewsContainerInteractorImpl implements CommonContainerInteractor {
    ...
    public List<BaseEntity> getCommonCategoryList(Context context) {
        ...
        resultData.add(new BaseEntity("0", "0"));
        resultData.add(new BaseEntity("1","1"));
        resultData.add(new BaseEntity("2","2"));
        resultData.add(new BaseEntity("3","3"));
        return resultData;
    }
}
